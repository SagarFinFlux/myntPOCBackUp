...
export class TreoVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
     ...
     * @private
     */
    private _hasCurrentUrlAsChildren(item: TopNavigationItem, url: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: TopNavigationItem, item: TopNavigationItem): boolean
    {

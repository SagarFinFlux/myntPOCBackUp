...
import { TopNavigationItem, TreoVerticalNavigationAppearance, TreoVerticalNavigationMode, TreoVerticalNavigationPosition } from '@treo/components/navigation/navigation.types';
...
export class TreoVerticalNavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    @Input() navigation: TopNavigationItem[];
    ...
    onCollapsableItemCollapsed: ReplaySubject<TopNavigationItem> = new ReplaySubject<TopNavigationItem>(1);
    onCollapsableItemExpanded: ReplaySubject<TopNavigationItem> = new ReplaySubject<TopNavigationItem>(1);
     ...
     * @param item
     */
    openAside(item: TopNavigationItem): void
    {
     ...
     * @param item
     */
    toggleAside(item: TopNavigationItem): void
    {
        // Toggle

...
export class TreoNavigationService
{
    ...
    private _navigationStore: Map<string, TopNavigationItem[]> = new Map<string, any>();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: TopNavigationItem[]): void
    {
        // Add to the store
     ...
     * @returns {any}
     */
    getNavigation(key: string): TopNavigationItem[]
    {
     ...
     * @returns {TopNavigationItem[]}
     */
    getFlatNavigation(navigation: TopNavigationItem[], flatNavigation: TopNavigationItem[] = []): TopNavigationItem[]
    {
     ...
     * @param navigation
     */
    getItem(id: string, navigation: TopNavigationItem[]): TopNavigationItem | null
    {
        for ( const item of navigation )
        {
            if ( item.id === id )
    ...
    getItemParent(
        ...
        parent: TopNavigationItem[] | TopNavigationItem
    ): TopNavigationItem[] | TopNavigationItem | null
    {
        for ( const item of navigation )
        {
            if ( item.id === id )
